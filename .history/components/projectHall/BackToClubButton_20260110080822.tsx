...
export function BackToClubButton({
  ...
  if (studioVisibility === 'public') {
    return (
      <button
        onClick={() => router.back()}
        className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-lg transition-colors border border-zinc-700 mr-4"
      >
  ...
  return (
    <div className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-900 text-gray-400 font-semibold rounded-lg border border-zinc-800 cursor-not-allowed mr-4">
