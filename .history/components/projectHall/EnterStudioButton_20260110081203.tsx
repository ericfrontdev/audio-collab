...
export function EnterStudioButton({
  ...
  if (isMember) {
    return (
      <Link
        ...
        className="inline-flex items-center gap-2 px-6 py-3 bg-primary hover:bg-primary/90 text-white font-semibold rounded-lg transition-colors cursor-pointer"
      >
  ...
  if (studioVisibility === 'public') {
    return (
      <Link
        href={`/projects/${projectId}/studio`}
        className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-lg transition-colors border border-zinc-700 cursor-pointer"
      >
