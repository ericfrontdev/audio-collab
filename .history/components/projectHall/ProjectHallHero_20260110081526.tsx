...
export function ProjectHallHero({
  ...
  const t = useTranslations('projectHall.hero')
  const projectTitle = project.title || project.name || t('untitledProject')
  const studioVisibility = (project.studio_visibility || 'members_only') as
    | 'members_only'
    | 'public'
  ...
  return (
    <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl overflow-hidden">
      ...
      <div className="p-8">
        ...
        {/* Back to Club Button & Enter Studio Button */}
