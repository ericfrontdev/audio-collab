...
CREATE POLICY IF NOT EXISTS "Anyone can view project members"
  ON project_members FOR SELECT
  USING (true);

CREATE POLICY IF NOT EXISTS "Project owners can add members"
...
CREATE POLICY IF NOT EXISTS "Project owners can remove members"
