...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "Track creator or collaborators can insert takes" ON project_takes;
...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "Track creator or collaborators can update takes" ON project_takes;
...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "Track creator or collaborators can delete takes" ON project_takes;
